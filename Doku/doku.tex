...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{NX_Screenshots/spindel.png}
	\caption{Spindel inkl. Halterung und Aufnahmekegel} 
	\label{fig:spindel}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{NX_Screenshots/wagen.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{NX_Screenshots/arm_vorne.png}
