...
Die Spezifikationen der Maschine sind:
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.45\textwidth]{bilder/IMG_2629.JPG}
...
\begin{equation}\label{steigungHin}
	...
	\end{cases}	
\end{equation}\\
Damit ist jetzt die Steigung für alle möglichen Fälle definiert, so lange sie sich nur linear verändern darf. Für eine anderweitige Abhängigkeit, Beispielsweise eine exponentielle zu- und Abnahme der Steigung ist die obige Funktion entsprechend anzupassen. Für die ersten Tests wird darauf jedoch verzichtet und eine rein lineare Funktion gewählt.\\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\columnwidth]{bilder/IMG_2616.JPG}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\columnwidth]{NX_Screenshots/wagen.png}
...
\begin{figure}
	\centering
	\includegraphics[width=1\columnwidth]{NX_Screenshots/arm_vorne.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[angle=270, width=1\columnwidth]{bilder/skizze.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\columnwidth]{bilder/carbowickler_software.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\columnwidth]{bilder/IMG_2662.JPG}
...
\section{Fazit}
Im Rahmen der Vorlesung konnte der mechanische Aufbau nicht fertiggestellt werden, da die dazu nötige Fräse nicht zur Verfügung stand. Die Fertigung der verbleibenden Teile erfolgt sobald die Fräse wieder einsatzbereit ist. Auch die Software kann erst an der fertigen Maschine sinnvoll getestet werden. Die Vorarbeit hierfür ist jedoch, soweit möglich, geleistet.
